...
%   modified 10/20/2016 MIH, fixed bug for handling of two arguments
%   modified 04/10/2020 MIH, eliminated warnings in code, changed documentation, minor changes
...
switch nargin
    ...
    case 1
        style = [];     spacing = [];   labels = [];    varargin = [];
    case 2
        spacing = [];   labels = [];    varargin = [];
    case 3
        labels = [];    varargin = [];
    case 4
        varargin = [];
...
%   x is x-axis vector, required.
%   y is y-axis vector, required.
